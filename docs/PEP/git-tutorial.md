...
gitGraph
       ...
       commit
```
When working with git, you can represent commits, branches and forks in a diagram like this. Each full circle represents
a commit and branching off is either a branch or a fork. An empty circle represents a pull request where branches or 
forks are merged back into each other. These diagrams are often generated by sites like GitHub and IDEs to make 
development less messy.
